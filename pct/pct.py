...
if __name__=="__main__":
	...
	all_transactions = json.load(open('json_files/doc_transactions','r'))
	cluster_labels = json.load(open('json_files/cluster_labels','r'))
	...
	# print len(cluster_cfi)
        json.dump(cluster_transactions,
                open('json_files/cluster_transactions','w'))
	json.dump(doc_clusters,open('json_files/doc_clusters','w'))
	json.dump(cluster_cfi, open('json_files/cluster_cfi','w'))
